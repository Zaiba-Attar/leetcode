...
|----|-------------|-----|------------|--------|-------------|------------|--------|------------|--------|------------|--------|---------------|----------------|----------------|-------|----------------|--------|
| 1  | Example Problem | [Link](https://example.com) | Medium | notSolved | 2025-03-27 | ✅ | [Code](#code-1) | ❌ | [Code](#code-2) | ❌ | [Code](#code-3) | Two Pointers, Sliding Window | O(n) | O(1) | Edge case: empty input | [Diagram](https://excalidraw.com) | Use prefix sum to optimize |
| 2  |              |     |            |        |             |            |        |            |        |            |        |               |                |                |       |                |        |
